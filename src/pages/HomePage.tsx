        ...
        <div className="container heroInner">
          ...
          <Reveal className="heroVisual">
            <div className="visualCard">
              <ResponsiveImage
                src={siteImages.home.src}
                alt={siteImages.home.alt}
          ...
          <div className="statsGrid">
            <Reveal className="statCard">
              ...
              <div className="statValue">
                <CountUp end={500000} suffix="+" duration={2000} />
              </div>
              <div className="statLabel">Monthly meters production</div>
            </Reveal>
            <Reveal className="statCard">
              <div className="statIcon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="statValue">
                <CountUp end={150} suffix="+" duration={2000} />
              </div>
              <div className="statLabel">Members team</div>
            </Reveal>
            <Reveal className="statCard">
              <div className="statIcon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="statValue">World Wide</div>
              <div className="statLabel">MNC customers</div>
            </Reveal>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="imageGrid">
            <Reveal className="imageCard">
              ...
              />
              <div className="imageCaption">Weaving</div>
            </Reveal>
            <Reveal className="imageCard">
              <ResponsiveImage
            ...
            <Reveal className="imageCard">
              <ResponsiveImage
                ...
                sizes="(max-width: 720px) 100vw, 33vw"
              />
              <div className="imageCaption">Leno Gauze</div>
            </Reveal>
          </div>
        </div>
      </section> */}
        ...
        <div className="container">
          <Reveal>
            <div className="sectionHead">
              ...
              <p className="sectionLead">
                A focused manufacturing workflow for predictable output, consistent quality, and smooth repeat ordering.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid3">
            <Reveal className="card">
              ...
              <h3 className="cardTitle">Inhouse Process</h3>
              <p className="muted">
                Our inhouse process ensures that every meter is manufactured with the highest quality standards.
              </p>
            </Reveal>
            <Reveal className="card">
              <div className="cardIcon" aria-hidden="true">
